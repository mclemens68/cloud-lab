...
output "aws_rosa_cluster_ids" {
  value = length(module.rosa) > 0 ? module.rosa[0].cluster_ids : {}
}
output "aws_rosa_api_urls" {
  value = length(module.rosa) > 0 ? module.rosa[0].api_urls : {}
}
output "aws_rosa_console_urls" {
  value = length(module.rosa) > 0 ? module.rosa[0].console_urls : {}
}